...
function updateStatus(moves) {
    if (moves.length == 0) {
        writeStatus("There are no moves left. Gameover. 🚧 /nEs sind keine züge mehr Übrig 🚧");
    } else if (moves.length === 1) {
        writeStatus("There is <strong>exactly one</strong> possible move. /nEs gibt <strong>exactly one</strong> mögliche züge");
    } else {
